...
public class UserBoardDTO {
	...
	public UserBoardDTO(int board_num, String board_group, Date board_date, String title, int recommend,
			String m_content, String m_image, int user_num, String user_nick) {
		super();
	...
	public String toString() {
		...
		builder.append("UserBoardDTO [board_num=").append(board_num).append(", board_group=").append(board_group)
				...
				.append(", user_num=").append(user_num).append(", user_nick=").append(user_nick).append("]");
