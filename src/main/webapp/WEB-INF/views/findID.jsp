...
<body>
	...
	<div class="loginstyle">
		<center>
			<button type="button"
				class="btn btn-outline-secondary btn-lg btn-block">SEARCH ID</button>
			<form name="f" action="find.do" method="post">
					...
					<tbody class="tbody-dark">
						...
						<tr>
							<td colspan="2" align="center">
								<button type="button" onclick="searchID()" class="btn btn-secondary">찾기</button>
								<br>
							</td>
						</tr>
					</tbody>
				...
				<c:if test="${user_id != null}">
									<div style="color: red">회원님의 아이디는 <b>${user_id }</b> 입니다.</div>
											<br>
